...
function UsernameForm({onSubmitUsername}) {
  ...
  // No entanto, para alterar o seu conteúdo, usando uma função set
...
function handleChange(event) {
    ...
    /*
    // o imput será válido se o seu conteúdo for idêntico
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      {/* O conteúdo da variável de estado pode ser lido sem necessidade da função auxiliar*/}
